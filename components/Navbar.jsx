...
const Navbar = () => {
    ...
    const [pageScroll, setPageScroll] = useState(false)
        ...
        useEffect(() => {
            const sub = window.addEventListener('scrol', () =>
...
{!navigation && (
    ...
    <div className={
        ...
        <div className={
            navigation ? 'fixed left-0 top-0 w-4/5 h-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-10 ease-in duration-500'
             : "fixed top-0 left-[-100%] p-10 h-full ease-in duration-500"}>
                ...
                <div>
                        <div className='flex w-full items-center justify-between'>
                            <Link href='/#home'>
                                <h2 onClick={() => setNavigation(false)} className='text-3xl font-bold uppercase underline underline-offset-2 tracking-wider cursor-pointer'>
                                    Joe
                                </h2>
                            </Link>
